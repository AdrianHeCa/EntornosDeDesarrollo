...
class Fondo(pygame.sprite.Sprite):
    def __init__(self) -> None:
        ...
        self.image = pygame.image.load("Python/PyGame/Planet Defenders/img/fondo.jpg")
...
class Planeta(pygame.sprite.Sprite):
    def __init__(self) -> None:
        super().__init__()
        self.image = pygame.image.load("Python/PyGame/Planet Defenders/img/planeta.png")
...
class Anillo(pygame.sprite.Sprite):
    def __init__(self) -> None:
        super().__init__()
        self.imagen_original = pygame.image.load("Python/PyGame/Planet Defenders/img/anillo.png")
...
class Enemigo(pygame.sprite.Sprite):
    def __init__(self, pantalla):
        super().__init__()
        self.imagen_original = pygame.image.load("Python/PyGame/Planet Defenders/img/enemigo.png")
        self.imagen_original = pygame.transform.scale(self.imagen_original, (50, 50))
        self.imagen_explosion = pygame.image.load("Python/PyGame/Planet Defenders/img/explosión.png")
